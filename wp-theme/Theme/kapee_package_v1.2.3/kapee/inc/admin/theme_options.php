...
if ( ! class_exists( 'Redux' ) ) {
	...
	*/
	Redux::setSection( $opt_name, array(
        'title'      		=> esc_html__( 'Mobile Navbar', 'kapee' ),
        ...
        'fields'     		=> array(
			array(
				...
				'subtitle'    	=> esc_html__( 'Show/Hide mobile bottom navbar in mobile device.', 'kapee' ),
			...
			array(
				...
				'subtitle'    	=> esc_html__( 'Show/Hide navbar label.', 'kapee' ),
                'on'       		=> esc_html__('Show','kapee'),
				'off'      		=> esc_html__('Hide','kapee'),
				'default'  		=> 1,
            ),
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     	=> array(
			...
			/* array(
                ...
                'type'   => 'info',
                'notice' => false,
                'title' => esc_html__( 'Site Skin Color', 'kapee' ),
            ),			
			array(
                'id'       			=> 'site-skin',
                'type'     			=> 'button_set',
                'title'    			=> esc_html__('Site Skin','kapee'),
                'subtitle' 	   		=> esc_html__('Site skin color work on full website light/dark version.','kapee'),
                'options'  			=> array(
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(						
			...
			array(
                ...
                'subtitle' 	   		=> esc_html__('Enable/disable header login/register popup.','kapee'),
                'on'       			=> esc_html__('Enable','kapee'),
				'off'      			=> esc_html__('Disable','kapee'),
				'default'  			=> 1,
            ),
			array(
                ...
                'options'  			=> array(
					...
					3 		=> array(
                        'alt' 	=> '3',
                        'img' 		=> KAPEE_ADMIN_IMAGES . 'layout/myaccount/3.jpg'
                    ),
			...
			array(
                ...
                'subtitle' 	   		=> esc_html__('Enable/disable header minicart popup.','kapee'),
                'on'       			=> esc_html__('Enable','kapee'),
				'off'      			=> esc_html__('Disable','kapee'),
				'default'  			=> 1,
            ),
			array(
                ...
                'options'  			=> array( 
                    ...
                    4	=> array(
                        'alt' 	=> '4',
                        'img' 		=> KAPEE_ADMIN_IMAGES . 'layout/cart/4.jpg'
                    ),
					5	=> array(
                        'alt' 	=> '5',
                        'img' 		=> KAPEE_ADMIN_IMAGES . 'layout/cart/5.jpg'
                    ),
					6	=> array(
                        'alt' 	=> '6',
                        'img' 		=> KAPEE_ADMIN_IMAGES . 'layout/cart/6.jpg'
                    ),
                ),
                'default'  			=> 1,
            ),
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     		=> array(
			...
			array(
                ...
                'type'     			=> 'switch',
                'title'    			=> esc_html__('Show Categories Hierarchical','kapee'),
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
                ...
                'type'     		=> 'switch',
                'title'    		=> esc_html__( 'Page Title', 'kapee' ),
				'subtitle'    	=> esc_html__( 'Show/Hide shop page title.', 'kapee' ),
                'default'  		=> 1,
                'on'       		=> esc_html__('Show','kapee'),
                'off'      		=> esc_html__('Hide','kapee'),
            ),
			array(
                ...
                'type'     		=> 'switch',
                'title'    		=> esc_html__('Products View Mode Icon','kapee'),
				'subtitle'      => esc_html__( 'Products view mode icon show or hide on product header', 'kapee' ),
                'on'       		=> esc_html__('Show','kapee'),
				'off'      		=> esc_html__('Hide','kapee'),
				'default'  		=> 1,
            ),
			array(
                ...
                'type'     		=> 'button_set',
                'title'    		=> esc_html__( 'Products Default View', 'kapee' ),
                'options'  		=> array(
			...
			array(
                ...
                'type'          => 'slider',
                'title'         => esc_html__('Products Per Page','kapee'),
                'subtitle'      => esc_html__('Show number of products per page.','kapee'),
                'default'       => 12,
                'min'           => 6,
                'step'          => 1,
                'max'           => 120,
			...
			array(
                ...
                'type'     		=> 'switch',
                'title'    		=> esc_html__('Products Per Page Dropdown','kapee'),
				'subtitle'     	=> esc_html__( 'Show products per page dropdown on products header', 'kapee' ),
                'on'       		=> esc_html__('Show','kapee'),
				'off'      		=> esc_html__('Hide','kapee'),
				'default'  		=> 1,
            ),
			array(
                ...
                'type'     		=> 'text',
                'title'    		=> esc_html__('Products Per Page Variations', 'kapee' ),
			...
			array(
				...
				'subtitle' 	   	=> esc_html__( 'Enable ajax filter on shop and product archive pages.', 'kapee' ),
                'on'       		=> esc_html__('Enable','kapee'),
				'off'      		=> esc_html__('Disable','kapee'),
				'default'  		=> 0,
            ),
			array(
                'id'       		=> 'shop-top-filter',
                'type'     		=> 'switch',
                'title'    		=> esc_html__('Shop Top Filter','kapee'),
				'subtitle' 	   	=> esc_html__( 'Enable shop filters on products top.', 'kapee' ),
                'on'       		=> esc_html__('Enable','kapee'),
				'off'      		=> esc_html__('Disable','kapee'),
				'default'  		=> 0,
            ),
			...
			array(
                ...
                'type'     		=> 'button_set',
                'title'    		=> esc_html__( 'Products Columns On Mobile', 'kapee' ),
				'subtitle'      => esc_html__( 'How many products you want to show per row on mobile?', 'kapee' ),
                'options'  		=> array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
                ...
                'options'  => array(
                    'blog-bottom-overlap' => array(
                        ...
                        'img' => KAPEE_ADMIN_IMAGES . 'layout/default-bottom-overlap.png',
                    ),
					'blog-bottom-overlap-center' => array(
                        'title' => 'Bottom Overlap Center',
                        'alt' => 'Bottom Overlap Center',
                        'img' => KAPEE_ADMIN_IMAGES . 'layout/bottom-overlap-center.png',
                    ),
                    'blog-full-width' => array(
                        'title' => 'Full Width',
                        'alt' => 'Full Width',
                        'img' => KAPEE_ADMIN_IMAGES . 'layout/full-width.png',
                    ), 
			...
			array(
                ...
                'options'  => array(
                    'blog-grid-bottom-overlap' => array(
                        'title' => 'Default Bottom Overlap',
                        'alt' => 'Default Bottom Overlap',
                        'img' => KAPEE_ADMIN_IMAGES . 'layout/grid-default-bottom-overlap.png',
                    ),
					'blog-grid-bottom-overlap-center' => array(
                        'title' => 'Default Bottom Overlap Center',
                        'alt' => 'Default Bottom Overlap Center',
                        'img' => KAPEE_ADMIN_IMAGES . 'layout/grid-default-bottom-overlap-center.png',
                    ),
                    'blog-grid-full-width' => array(
                        'title' => 'Full Width',
                        'alt' => 'Full Width',
                        'img' => KAPEE_ADMIN_IMAGES . 'layout/grid-full-width.png',
                    ), 
			...
			array(
                ...
                'subtitle' => esc_html__('Show/hide blog post thumbnail.','kapee'),
                'on'       => esc_html__('Show','kapee'),
				'off'      => esc_html__('Hide','kapee'),
				'default'  => 1,
            ),
