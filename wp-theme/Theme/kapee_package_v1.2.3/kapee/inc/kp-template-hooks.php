 ...
 * @see kapee_close_popup()
 */
add_action( 'kapee_footer', 'kapee_template_footer', 10 );
add_action( 'kapee_footer', 'kapee_back_to_top', 20 );
add_action( 'kapee_footer', 'kapee_newsletter_popup', 30 );
add_action( 'kapee_footer', 'kapee_mobile_bottom_navbar', 40 );
add_action( 'kapee_body_bottom', 'kapee_close_popup', 50 );