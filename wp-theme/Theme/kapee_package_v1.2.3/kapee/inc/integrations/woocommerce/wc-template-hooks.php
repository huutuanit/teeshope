...
add_action( 'kapee_before_shop_loop_item_title', 'kapee_sale_product_countdown', 15 );
 ...
 * @see kapee_single_product_offer()
 * @see kapee_single_product_brands()
 * @see kapee_single_product_service()
 ...
 * Footer
 */
add_action( 'kapee_body_bottom', 'kapee_login_signup_popup', 55 );
add_action( 'kapee_body_bottom', 'kapee_mini_cart_sidebar', 60 );
add_action( 'kapee_body_bottom', 'kapee_canvas_sidebar', 65 );
