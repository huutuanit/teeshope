...
if ( ! function_exists( 'kapee_product_row_classes' ) ):
	function kapee_product_row_classes(){
		...
		$action_buttons_style 	= kapee_get_loop_prop( 'product-action-buttons-style' );
		$products_columns 		= kapee_get_loop_prop( 'products-columns' );
		$classes[] 				= $product_style;		
		$classes[] 				= $action_buttons_style;		
 ...
 * Mini Cart Sidebar
 */
if( ! function_exists( 'kapee_mini_cart_sidebar' ) ) :
	function kapee_mini_cart_sidebar(){ 
	
		$mini_cart_text	= apply_filters( 'kapee_mini_cart_text', esc_html__('My Shopping cart','kapee') );?>
	
		<div class="minicart-slide-wrapper">
			<div class="minicart-header">
				<h3 class="minicart-title"><?php echo esc_html($mini_cart_text);?></h3>
...
if( ! function_exists( 'kapee_empty_mini_cart_button' ) ) :
	...
	<p class="woocommerce-empty-mini-cart__buttons">
		<a class="button" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"><?php esc_html_e('Shopping Now','kapee');?></a>
	</p>
	<?php }
endif;
