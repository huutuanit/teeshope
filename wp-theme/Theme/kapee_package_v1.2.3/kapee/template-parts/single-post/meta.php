...
$meta_values=kapee_get_option( 'specific-post-meta', array( 'post-author', 'post-category', 'post-comments', 'post-share' ) );

if( ! kapee_get_option('post-meta',1) || empty($meta_values) ) return;
?>
			...
			switch ( $meta_value ) {
				case 'post-author': ?>	
					<span class="author-link vcard">
						<?php esc_html_e('By', 'kapee');?> <?php echo the_author_posts_link(); ?>
					</span> <?php					
					break;
				case 'post-date': 					
