...
$classes[] = ( kapee_get_option('post-meta', 1) ) ? kapee_get_option('post-meta-separator', 'meta-separator-colon') : '';
$classes[] = ( kapee_get_option('post-meta', 1) && kapee_get_option('post-meta-icon', 1) ) ? 'post-meta-icon' : 'post-meta-label';
$classes[] = ( kapee_get_option('post-fancy-date', 1) ) ? kapee_get_option('fancy-date-style', 'fancy-square-date') : '';
