...
if( ! KAPEE_WOOCOMMERCE_ACTIVE || kapee_get_option( 'catalog-mode', 0 ) || ( ! is_user_logged_in() && kapee_get_option( 'login-to-see-price',0 ) ) ) return;
	...
	<a href="<?php echo esc_url($cart_url);?>">		
		...
		switch ($cart_style) {
			...
			case 2:?>				
				...
				break;				
			case 3:?>				
				<div class="header-cart-icon <?php echo esc_attr( kapee_get_option( 'header-cart-icon','cart-icon') );?>"></div>
				<div class="cart-wrap">
					<small><?php esc_html_e('Cart','kapee');?></small>
					<span class="header-cart-item-text"><?php echo WC()->cart->get_cart_contents_count(); ?> <?php echo esc_html( _n( 'item', 'items', $count, 'kapee' ) ); ?></span>
				</div>
				<?php
				break;
			case 4:?>				
